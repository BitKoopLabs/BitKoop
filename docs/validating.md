...
2. Download the latest `docker-compose.yml` from the official repository:
   ...
   ```sh
   curl -L -o docker-compose.yml https://raw.githubusercontent.com/ye-du-dev/BitKoop-Subnet-Validator/main/docker-compose.yml
   ```
...
1. Clone the repository and set up your environment:
   ...
   ```sh
   git clone https://github.com/ye-du-dev/BitKoop-Subnet-Validator.git
   cd BitKoop-Subnet-Validator
   python3 -m venv venv
