...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('coupons', sa.Column('miner_coldkey', sa.String(), nullable=True))
    op.add_column('coupons', sa.Column('use_coldkey_for_signature', sa.Boolean(), nullable=True))
